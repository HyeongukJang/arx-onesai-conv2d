...
int main()
{
  if(EXCLUSIVE_ID==0)
  {
    ...
    input_info = matrix_alloc(IN_MATRIX_DATATYPE, INPUT_MATRIX_SIZE, INPUT_MATRIX_SIZE, NULL);
    //input_info = matrix_alloc(IN_MATRIX_DATATYPE, 34, 32, NULL);
    //input_info = matrix_alloc(IN_MATRIX_DATATYPE, 16, 8, NULL);
    kernel_info = matrix_alloc(IN_MATRIX_DATATYPE, KERNEL_MATRIX_SIZE, KERNEL_MATRIX_SIZE, NULL);
